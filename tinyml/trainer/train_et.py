...
def resolve_arc_feature_names(explicit_features=None, feature_report: str | None = None, model_key: str = "et") -> tuple[list[str], list[str]]:
...
def main():
    ...
    selected_base_features, selected_feature_names = resolve_arc_feature_names(args.features, args.feature_report, model_key="et")
