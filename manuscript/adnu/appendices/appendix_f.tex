...
summarizes the values needed to connect the source artifacts to the manuscript
...
imbalanced, which is why the manuscript reports precision, recall, F1-score,
