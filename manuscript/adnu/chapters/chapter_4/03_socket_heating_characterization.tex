...
\begin{table}[H]
  ...
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{0.22\textwidth}p{0.105\textwidth}p{0.13\textwidth}p{0.08\textwidth}p{0.11\textwidth}p{0.135\textwidth}p{0.09\textwidth}@{}}
    \toprule
    \textbf{Load case} & \textbf{Socket} & \textbf{\shortstack{Time to\\38.2°C}} & \textbf{\shortstack{Mean\\A}} & \textbf{\shortstack{Final Device\\Temperature}} & \textbf{\shortstack{Final Infrared\\Thermometer}} & \textbf{\shortstack{Window\\(min)}} \\
    \midrule
