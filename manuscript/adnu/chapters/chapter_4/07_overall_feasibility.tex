...
and compare behavior against applicable protection-device standards. The
project schedule and cost breakdown in Appendices~\ref{app:h}
and~\ref{app:i} document the scope and material basis of this prototype-level
implementation.
