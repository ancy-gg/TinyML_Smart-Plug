...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{ch3/figure_3.1.png}
...
the smart plug as a measurement-only device. The sensing inputs were converted
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{ch3/figure_3.2.png}
...
uploads selected telemetry. Keeping the protection decision on the
microcontroller prevents the relay action from depending on internet
availability, while the cloud and PWA remain useful for monitoring, labeling,
and documentation.

\section{System Inputs, Processing, and Outputs}
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.25\textwidth}p{0.28\textwidth}p{0.35\textwidth}}
    \toprule
    Variable group & Source & Use in the prototype \\
    \midrule
    ...
    NTC temperature & 10 k$\Omega$ NTC thermistor and divider computation & Baseline thermal measurement for socket-temperature estimation \\
