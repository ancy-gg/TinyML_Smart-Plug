...
\textit{Figure~\ref{fig:ch3-conceptual-framework}} summarizes this research model.
\begin{figure}[H]
  \centering
...
\textit{Figure~\ref{fig:ch3-conceptual-framework}} presents the conceptual framework 
...
\textit{Table~\ref{tab:ch3-system-variables}}. The table separates direct
...
\textit{Table~\ref{tab:ch3-system-variables}} shows that current is used by several
...
\textit{Figure~\ref{fig:ch3-system-architecture}} presents the system architecture used
...
\textit{Figure~\ref{fig:ch3-system-architecture}} places the ESP32-S3 at the center of
