...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (img) at (0,0)
      {\includegraphics[width=0.84\textwidth]{ch3/figure_3.13.png}};
...
Figure~\ref{fig:ch3-pwa-dashboard} displays the status and protection state,
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (img) at (0,0)
      {\includegraphics[width=0.86\textwidth]{ch3/figure_3.14.png}};
    \begin{scope}[x={(img.south east)},y={(img.north west)}]
    \end{scope}
  \end{tikzpicture}
...
Figure~\ref{fig:ch3-pwa-history} documents the alert and event list. The history
