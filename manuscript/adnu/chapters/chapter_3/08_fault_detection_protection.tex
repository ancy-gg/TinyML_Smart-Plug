...
These thresholds were verified from the firmware and are treated as design
choices for supply-state supervision. The manuscript does not claim validated
voltage-protection performance because Chapter~\ref{chap:results} does not
include a separate voltage-abnormality test set.
