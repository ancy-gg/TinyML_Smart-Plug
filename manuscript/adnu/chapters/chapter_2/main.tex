...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.20\textwidth}p{0.30\textwidth}p{0.40\textwidth}}
    ...
    Conduction intermittence & Low-current run time; low-current ratio; zero-cross variance; absolute RMS-current delta; baseline z-deviation & These quantities represent restrikes, current interruption, partial conduction, and unstable cycle timing, which are physically consistent with series arcs and weak-contact behavior {[}34{]}, {[}36{]}, {[}37{]}, {[}52{]}, {[}54{]}. \\
