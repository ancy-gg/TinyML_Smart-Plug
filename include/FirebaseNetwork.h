...
private:
  struct LiveSnapshot {
    ...
    float spec_entropy = 0.0f, neg_dip_event_ratio = 0.0f, pre_dip_spike_ratio = 0.0f, thd_i = 0.0f;
  ...
  struct Rec {
    ...
    float midband_residual_rms, hf_band_energy_ratio, spec_entropy, neg_dip_event_ratio, pre_dip_spike_ratio, thd_i;
