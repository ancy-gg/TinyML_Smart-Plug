...
static constexpr uint8_t ADS_OUTPUT_DECIMATE = 3;
static constexpr bool  ADS_OUTPUT_USE_MEDIAN3 = false;
...
static constexpr float CURRENT_FRAME_MIN_FS_HZ      = 35000.0f;
