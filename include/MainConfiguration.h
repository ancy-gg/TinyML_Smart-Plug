...
static constexpr uint32_t ARC_CURRENT_RETURN_VERIFY_MS = 200UL;
...
static constexpr uint32_t ARC_MODEL_LATCH_OFF_MS       = 2000UL;
static constexpr uint32_t ARC_MODEL_FEATURE_HOLD_MS    = 2000UL;
